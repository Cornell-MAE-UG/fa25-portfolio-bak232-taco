---
layout: project
title: MAE 3720 Final HW - Part 2
description: The portfolio project associated with MAE 3720, the Mechanics of Engineering Materials
technologies: [Ansys]
...
![Dimensions of our final design, displayed in inches]({{ "/assets/images/wrench-dimensions.png" | relative_url }})
{: .inline-image-r style="width:20px !important" }
...
![Dimensions of our final design, displayed in inches]({{ "/assets/images/load-bc1.png" | relative_url }})
{: .inline-image-r style="width: 20px"}
...
![Dimensions of our final design, displayed in inches]({{ "/assets/images/load-bc2.png" | relative_url }}) {: .inline-image-r style="width: 20px"}
...
![Contour plot of elastic strain]({{ "/assets/images/elastic-strain.png" | relative_url }}) {: .inline-image-r style="width: 20px"}
...
![Contour plot of normal stress]({{ "/assets/images/principal-stress.png" | relative_url }}) {: .inline-image-r style="width: 20px"}
